...
public class ConsoleAreaErrorStream extends OutputStream {
    ...
    /**
     * Needed for testing
     * Returns the internal {@link StringBuilder} instance used to accumulate characters
     * before they are flushed to the associated {@link ConsoleArea}.
     * <p>
     * This method is primarily intended for testing purposes to allow verification of the
     * internal state of the {@code ConsoleAreaErrorStream}. It provides direct access to the
     * {@code StringBuilder} used to store characters before they are processed and sent to
     * the {@code ConsoleArea}.
     * </p>
     *
     * @return the internal {@link StringBuilder} instance used to accumulate characters
     */
